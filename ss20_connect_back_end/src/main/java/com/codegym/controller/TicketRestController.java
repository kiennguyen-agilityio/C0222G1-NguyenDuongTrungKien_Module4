...
//    }
//
    @GetMapping("/search/{startPosition}")
    public ResponseEntity<?> searchByStartPosition(@PathVariable String startPosition) {
        List<Ticket> tickets = service.searchByStartPosition(startPosition);
